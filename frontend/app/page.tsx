...
type RunState = { task_id: string | null; session_id: string; scenario_id: number; status: "QUEUED" | "RUNNING" | "SUCCEEDED" | "FAILED"; logs: RunLog[]; simulation_artifacts?: SimulationArtifact[]; progress_stage?: string | null; result?: Record<string, unknown> | null; error?: string | null; created_at?: string | null; started_at?: string | null; completed_at?: string | null };
